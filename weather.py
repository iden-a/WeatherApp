...
def getWeather(root):
    ...
    #need to convert time to eastern time, still working on. 
...
root.configure(bg="#2C4251") # the background of the app 
...
textField = tk.Entry(root, font = t, bg="white", fg="#2C4251")
textField.pack(pady=20)
textField.focus()
textField.bind('<Return>', getWeather)

label1 = tk.Label(root, font = t, bg="#2C4251") # condition, temp info
label1.pack()

label_Image = tk.Label(root, )

label2 = tk.Label(root, font = f,bg="#2C4251") # max, min, humidty info 
label2.pack()
